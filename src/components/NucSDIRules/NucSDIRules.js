...
const NucSDIRules = () => {
  ...
  return (
    <div className="nucSDI-rules-wrapper">
        ...
        <h2 className="text-center-bold">Introducing Nuclear Units and SDI Defense Units:</h2>
        ...
        <p>Just like the other Sections of these Official Rules, the relevant Unit, Order Element, and Move Element Codes will be placed in parentheses next to the names of the Codes.  The parentheses themselves ARE NOT part of the Codes.  When other Score Sheet Operator Codes get used in the Score Sheet Complete Turn entry examples, they will also be referenced and indicated within parentheses.</p>
        ...
        <h3 className="text-center-bold">Handing Off (HO) of Mobile SDI Defense Units (MSDI) and both types of Mobile Nuclear Unit (either MTN or MIN) Rules:</h3>
          <p>Here, see Official Rules:  All Score Sheet Move Element Codes:  Hand Off Move Element Code OR Official Rules: All Treaty Negotiations Chart Rules: Section Three for all information pertaining to the Handing Off (HO) of both Mobile Nuclear Units and/or Mobile SDI Defense Units.   The Hand Off Move Element Code is GOVERNED ONLY by VARIABLE RULES.</p>
        <h3 className="text-center-bold">Picking Up (PU) of Mobile SDI Defense Unit and both types of Mobile Nuclear Unit Rules:</h3>
          <p className="padding-bottom">Here, see Official Rules:  All Score Sheet Move Element Codes:  Pick Up Move Element Code for all information pertaining to the Rules for Picking Up Mobile SDI Defense Units and Mobile Nuclear Units of either type.  The Pick Up Move Element Code is GOVERNED ONLY by FIXED RULES.</p>
          <h3 className="text-center-bold">Dropping Off (DO) of Mobile SDI Defense Unit and both types of Mobile Nuclear Unit Rules:</h3>
          <p>Here, see Official Rules:  All Score Sheet Move Element Codes:  Drop Off Move Element Code for all information pertaining to the Rules for dropping off Mobile SDI Defense Units and Mobile Nuclear Units of either type.  The Drop Off Move Element Code is GOVERNED ONLY by FIXED RULES.</p>
        <h3 className="text-center-bold">Declaring an Envoy (E=) to Arm (R) previously Activated Nuclear Units:</h3>
          <p className="padding-bottom">Here, see either or both of Official Rules:  All Unit Codes:  Envoy Unit Code --OR-- Official Rules:  All Order Element Codes:  Declare Envoy Order Element Code, for ALL INFORMATION pertaining to Declaring an Envoy (E=).  See also Section Four of the Treaty Negotiations Chart to determine the number of allowable times an Envoy Unit (E) may be declared during the course of a game.  The Envoy Unit IS THERE TO Arm (R) previously Activated (C) Nuclear Units EITHER AT A DISTANCE OR ADJACENTLY whenever the President IS NOT ADJACENTLY THERE NEXT to the Nuclear Unit to do so.  The President Unit ALREADY CAN ARM without needing to be declared as an Envoy. </p>
        ...
        <h3 className="text-center-bold" id="readiness">SECOND LEVEL:  Activate (C) a previously Deployed Nuclear Unit</h3>
          <p className="padding-bottom">Activating a Nuclear Unit allows it to later be Armed (R), which is like a nuclear weapon in real life "getting powered up" without yet receiving the authorization codes, which would be like Arming in Deterrence.  Activating is ALWAYS ITSELF A COMPLETE TURN, meaning no other Elements of either type can be contained within that Complete Turn activating a previously Deployed Nuclear Unit.  The Complete Turn Wait Time is a VARIABLE RULE that is changeable during either one or both rounds of Treaty negotiations.  The game starts with the Default Setting for this final setting in Section Two of the Treaty Negotiations Chart as 5 COMPLETE TURNS.  What this means, is that FIVE CONSECUTIVE COMPLETE TURNS BY BOTH PLAYERS MUST HAVE OCCURRED, EXCLUSIVE OF BOTH THE DEPLOY AND ACTIVATE ELEMENTS, for the Wait Time to have expired, making Activating a previously Deployed Nuclear Unit legal. </p>
        <h3 className="text-center-bold" id="readiness">THIRD LEVEL:  Arm a previously Activated(R)</h3>
          <p className="padding-bottom"></p>
        <h3 className="text-center-bold" id="readiness">FOURTH LEVEL:  Fire (F) a previously Armed Nuclear Unit</h3>
          <p className="padding-bottom"></p>
        <h3 className="text-center-bold">Buy SDI Defense(B) to Place SDI Defense Units on the Game Board:</h3>
          ...
          <p>Squares targeted during Nuclear Unit Firing (F) Move Elements that have AT LEAST ONE MOBILE SDI Defense Unit (MSDI) on each of them ONLY LOSE the Unit(s) NOT PAIRED FOR PROTECTION with each of the Mobile SDI Defense Units on that targeted square or squares.  For Fixed SDI Defense (FSDI) Units, NO OTHER UNITS AT ALL ON THAT SPECIFIC SQUARE that FSDI rests on are lost and thus remain on the Game Board.  A square CANNOT HOLD more than ONE TOTAL FIXED SDI Defense Unit.</p>
