...
const MIN = () => {
  return (
    <div className="det-cards" id="cards">
        ...
        <div className="label">
            <header>
                <h1 className="bold">Mobile Intermediate Nuclear Unit</h1>
                ...
                <div className="units-info">
                    ...
                    <h1>(MIN)</h1> <span className="bold right lg-text">8.0</span>
                </div>
                ...
                <div className="divider"></div>
                    <p className="indent no-divider"><strong className="bold">RANGE: </strong><span className="right">No more than two squares between first destroyed square and the Unit's current square location</span></p>
                <div className="divider"></div>
                ...
                <div className="divider lg"></div>
                    ...
                    <p>3. The player losing the MTN to capture deducts 8.0 Cash Value Points from his/her Cash Value Points Total on the Score Sheet.</p>
