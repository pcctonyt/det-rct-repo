    ...
    <div className="det-cards" id="cards">
        ...
        <div className="label">
            <header>
                ...
                <div className="divider lg"></div>
                    <p className="note">NOTE:  In the event of a Treaty where the use of Nuclear/SDI Units has been turned off, all Movement and Order Codes related to the Mobile Tactical Nuclear Unit become illegal (IMD-S).</p>
        </div>
    </div>
  )
}
