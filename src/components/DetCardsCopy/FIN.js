...
const FIN = () => {
  return (
    <div className="det-cards" id="cards">
        ...
        <div className="label">
            <header>
                <h1 className="bold">Fixed Intermediate Nuclear Unit</h1>
                ...
                <div className="units-info">
                    ...
                    <h1>(FIN)</h1> <span className="bold right lg-text">0.0</span>
                </div>
                ...
                <div className="divider"></div>
                    ...
                    <p className="indent no-divider"><strong className="bold">YIELD:</strong> <span className="right">Two Adjacent Squares</span></p>
                <div className="divider"></div>
                    <p className="indent no-divider"><strong className="bold">RANGE: </strong><span className="right">No more than two squares from Unit's current resting square</span></p>
                <div className="divider"></div>
                ...
                <div className="divider lg"></div>
                    ...
                    <p>7. Nuclear Units cannot destroy a Unit paired with a Mobile SDI Defense Unit.  Only one other Unit of any type at one time can be paired with one Mobile SDI Defense Unit</p>
