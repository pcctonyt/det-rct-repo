            ...
            <header>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider lg"></div>
                        ...
                        <p className="no-divider">3. The Treaty governs the number of times a new Envoy can be declared as a replacement to a previously captured or detroyed Envoy.  <em className="bold">Default Setting:</em> 1 time</p>
                    <div className="divider lg"></div>
