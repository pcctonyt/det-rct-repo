  ...
  return (
    <div className="general-rules-wrapper">
        ...
        <h2 className="text-center-bold">Setting Up the Game Board:</h2>
            ...
            <hr className="rule padding-bottom" />
            <h4 className="text-center padding-bottom nukes-setting-color">ALL 16 INFANTRY UNITS TOTAL:</h4>
            <p className="padding-bottom">For the Starting Player, the 8 Infantry Units start off on squares a2, b2, c2, d2, e2, f2, g2, and h2, just as the Pawns in chess do.  For the Responding Player, those 8 Infantry Units start off on squares a7, b7, c7, d7, e7, f7, g7, and h7.</p>
            <h4 className="text-center padding-bottom nukes-setting-color">ALL 4 LIEUTENANT UNITS TOTAL:</h4>
            <p className="padding-bottom">For the Starting Player, the 2 Lieutenant Units start off on squares a1 and h1.  For the two Responding Lieutenant Units, the squares they start on are squares a8 and h8.</p>
            <h4 className="text-center padding-bottom nukes-setting-color">ALL 4 AIRDROP UNITS TOTAL:</h4>
            <p className="padding-bottom">Moving inward, for the Starting Player, the two Airdrop Units start on squares b1 and g1, and then their Responding counterparts begin affairs on squares b8 and g8.</p>
            <h4 className="text-center padding-bottom nukes-setting-color">ALL 4 SERGEANT UNITS TOTAL:</h4>
            <p className="padding-bottom">Continuing on, the two Starting Sergeant Units rest on squares c1 and f1, and their Responding Sergeants get things going on squares c8 and f8.</p>
            <h4 className="text-center padding-bottom nukes-setting-color">BOTH GENERAL UNITS:</h4>
            <p className="padding-bottom">In the middle of the first rank, the Starting General rests on square d1, while the Responding adversary starts on square d8.</p>
            <h4 className="text-center padding-bottom nukes-setting-color">BOTH PRESIDENT UNITS:</h4>
            <p className="padding-bottom">The Starting Player's President Unit starts on square e1, while the Responding Player's leader begins on square e8.</p>
