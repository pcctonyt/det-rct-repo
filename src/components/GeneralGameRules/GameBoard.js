  ...
  return (
    <div>
        ...
        <div className="game-components">
            <button className="btn-group">Score Sheet</button>
            <button className="btn-group">Treaty Chart</button>
            <button className="btn-group">Game Rules</button>
            <button className="btn-group">Unit Codes</button>
        </div>
