        ...
        <div className="label">
            <header>
                ...
                <div className="units-info">
                    ...
                    <h1>(ENEG-Y)</h1> <span className="right lg-text">End Treaty Negotiations (1st treaty)</span>
                </div>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        <div className="divider"></div>
                        <p><span className="bold">The End Treaty Negotiations 1st Treaty Order Element Code does not have a Points Rule:</span></p>
                        <div className="divider"></div>
                        ...
                        <p className="bold"><span className="bold">There are no Variable Rules for the End Treaty Negotiations 1st Treaty Order Element.</span></p>
                </div>        
        </div>
    </div>
  )
