...
const C = () => {
  return (
    <div className="det-cards" id="cards">
        ...
        <div className="label">
            <header>
                <h1 className="text-center bold">Activate Order Code</h1>
                <div className="divider"></div>
                <p>Unlike the other Movement Codes Deploy (D) and Fire (F), but like the Arm (R) Movement Code associated with Nuclear Units, the Acivate Order Code DOES NOT change the position on the Game Board.  However, it allows previously deployed Nuclear Units to be armed on a subesquent Complete Turn.  This Code also describes which square the Nuclear Unit currently rests on.  This code has a Turn Wait time associated with it which can be changed during Treaty negotiations.  The Default Setting is 5 Turns, non-inclusive of both the Deploy and Activate Turns.</p>
                <div className="divider"></div>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        <p><span className="bold">When to use:</span><span className="right">The Player wishing to prepare a previously deployed Nuclear Unit of either Fixed or Mobile type for later arming uses this Order Code on the Score Sheet during that Complete Turn.  The Activate OrderCode ALWAYS COUNTS as ONE COMPLETE TURN, allowing no other Move Elements during that Turn.  Use Activate (C) at any time AFTER the Turn Wait Time has expired.</span></p>
                        <div className="divider"></div>
                    ...
                    <div className="divider"></div>
                        <p><span className="bold">When to Activate:</span><span className="right">Only Nuclear Units previously deployed and AFTER, non-inclusive, the Turn Wait Time has expired, can be activated.</span></p>
                        <div className="divider"></div>
