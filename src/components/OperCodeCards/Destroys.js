        ...
        <div className="label">
            <header>
                ...
                <div className="units-info">
                    ...
                    <h1>(z)</h1> <span className="right lg-text">G,L,S,A vs. Fixed Units, all non-SDI protected Units in Firing Moves</span>
                </div>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        ...
                        <p><em>G-z-d8</em>.  A General destroys only a Fixed Nuclear Unit (second z) on square d8.</p>  
                        ...
                        <p><em>G--zd8</em>.  A General only destroys a Fixed SDI Defense Unit (first z in third slot), but no Conventional Unit or Nuclear Unit, on square d8.</p>
