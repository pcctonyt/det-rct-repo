        ...
        <div className="label">
            <header>
                ...
                <div className="units-info">
                    ...
                    <h1>(x)</h1> <span className="right lg-text">Capture of Moveable Units</span>
                </div>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        ...
                        <p><em>Gxx-d8</em>.  A General captures both a Conventional Unit (first x) and a Mobile Nuclear Unit (second x) on square d8.</p>  
                        <p><em>Gxxxd8</em>.  A General captures a Conventional, Mobile Nuclear, and a Mobile SDI Defense Unit (third x) on square d8.</p> 
                        <p><em>G-x-d8</em>.  A General captures only an opposing Mobile Nuclear Unit (first x in second slot) on square d8.</p>
                        <p><em>G--xd8</em>.  A General captures only an opposing Mobile SDI Defense Unit(first x in third slot) on square d8.</p>
                        <p><em>G-xxd8</em>.  A General captures both a Mobile Nuclear Unit (first x in second slot) and a Mobile SDI Defense Unit (second x in third slot), but no Conventional Unit, on square d8.</p>
                    <div className="divider lg"></div>
                        <p className="note">NOTE:  The Shorthand syntax for Infantry Units capturing only another Conventional Unit WITHOUT OTHER UNITS is made (without writing the (x) operator) as follows: (letter of the file the Infantry starts on)(square code the Infantry captures).  Example: <em>ed5</em> (replaces exd5)  Also note that the "destroys" (z) operator can be used in this manner as well, except for the first slot (always an (x)).</p>
                </div>        
        </div>
    </div>
  )
