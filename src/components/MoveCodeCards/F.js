            ...
            <header>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        ...
                        <div className="divider"></div>
                        <p><span className="bold">Which squares to target - Intermediate Units:</span><span className="right">A fired Intermediate Unit targets a span of two adjacent squares not more than two squares away from (non-inclusive) that Unit's current resting square, ONLY WITHIN the current or previous accompanying friendly Conventional Unit's movement range, excepting the presence of any SDI Defense Unit(s) within those 2 squares.</span></p>
                        <div className="divider"></div>
