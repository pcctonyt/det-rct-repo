            ...
            <header>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        ...
                        <div className="divider"></div>
                        <p className="no-divider"><span className="bold">Use of the Border Breach Movement Code requires that the Players have changed Section Six of the Treaty Negotiations Chart to both install a Border and to enforce it, and also, that movement has occurred by the Player(s) over the Border.</span></p>
                    <div className="divider lg"></div>
