...
const BB = () => {
  return (
    <div className="det-cards" id="cards">
        ...
        <div className="label">
            <header>
                <h1 className="text-center bold">Border Breach Movement Code</h1>
                <div className="divider"></div>
                <p>This Code allows for any type of Unit(s) starting in the Turn-taking Player's territory (when the Players have agreed to install a Border during Treaty negotiations) to end its(their) movement during that current Complete Turn in the opposing Player's territory (see Official Rules: Borders, or Treaty Negotiations Chart - Section Six, for Variable Rules and Points Settings information).</p>
                <div className="divider"></div>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        ...
                        <div className="divider"></div>
                        <p className="no-divider"><span className="bold">The Border Breach Movement Code requires only that the Players have changed Section Six of the Treaty Negotiations Chart to both install a Border and to enforce it.</span></p>
                    <div className="divider lg"></div>
                        <p className="no-divider"><span className="bold">The Border Breach Movement Code also needs to be used when a Fired (F) Nuclear Unit destroys at least ONE UNIT in the opposing Player's territory.</span></p>
                    <div className="divider lg"></div>
